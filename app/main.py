...
from app.routers import (
    ...
    patient_consultation_details, patient_appointments, patient_create_appointments
)
...
app.include_router(patient_create_appointments.router, tags=["Patient Create Appointments"])